...
DROP DATABASE IF EXISTS `rainbow-house-search`;
CREATE DATABASE `rainbow-house-search`;
USE `rainbow-house-search`;
...
-- ----------------------------
--  Records of `t_house_subscribe`
-- ----------------------------
BEGIN;
INSERT INTO `t_house_subscribe` VALUES ('9', '17', '1', null, '3', '2017-11-26 11:06:23', '2017-12-02 09:21:01', '2017-12-03 00:00:00', '13888888888', '2');
COMMIT;

-- ----------------------------
--  Table structure for `t_house_tag`
-- ----------------------------
DROP TABLE IF EXISTS `t_house_tag`;
CREATE TABLE `t_house_tag` (
...
-- ----------------------------
--  Records of `t_house_tag`
-- ----------------------------
BEGIN;
INSERT INTO `t_house_tag` VALUES ('15', '18', '独立阳台'), ('15', '17', '空调'), ('16', '16', '光照充足'), ('17', '15', '随时看房'), ('17', '14', '集体供暖'), ('18', '13', '精装修'), ('19', '12', '独立卫生间'), ('19', '11', '独立阳台'), ('21', '19', '光照充足'), ('21', '20', '独立卫生间'), ('24', '10', '光照充足'), ('24', '3', '精装修'), ('24', '8', '集体供暖'), ('25', '21', '独立阳台');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_role` VALUES ('1', '1', 'USER'), ('2', '2', 'ADMIN'), ('3', '3', 'USER'), ('4', '4', 'USER'), ('5', '5', 'USER'), ('6', '6', 'USER'), ('7', '7', 'USER'), ('8', '8', 'USER');
COMMIT;

-- ----------------------------
--  Table structure for `t_subway`
-- ----------------------------
DROP TABLE IF EXISTS `t_subway`;
CREATE TABLE `t_subway` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
BEGIN;
INSERT INTO `t_subway` VALUES ('1', '13号线', 'bj'), ('2', '1号线', 'bj'), ('3', '2号线', 'bj'), ('4', '10号线', 'bj'), ('5', '8号线', 'bj'), ('6', '9号线', 'bj'), ('7', '7号线', 'bj');
COMMIT;
...
-- ----------------------------
--  Records of `t_subway_station`
-- ----------------------------
BEGIN;
INSERT INTO `t_subway_station` VALUES ('5', '1', '上地'), ('16', '1', '东直门'), ('4', '1', '五道口'), ('14', '1', '光熙门'), ('11', '1', '北苑'), ('8', '1', '回龙观'), ('2', '1', '大钟寺'), ('12', '1', '望京西'), ('15', '1', '柳芳'), ('3', '1', '知春路'), ('10', '1', '立水桥'), ('13', '1', '芍药居'), ('6', '1', '西二旗'), ('1', '1', '西直门'), ('9', '1', '霍营'), ('7', '1', '龙泽'), ('33', '4', '三元家庄'), ('51', '4', '三元桥'), ('41', '4', '丰台站'), ('52', '4', '亮马桥'), ('27', '4', '健德门'), ('46', '4', '公主坟'), ('44', '4', '六里桥'), ('53', '4', '农业展览馆'), ('62', '4', '分钟寺'), ('59', '4', '劲松'), ('28', '4', '北土城'), ('61', '4', '十里河'), ('58', '4', '双井'), ('55', '4', '呼家楼'), ('54', '4', '团结湖'), ('57', '4', '国贸'), ('35', '4', '大红门'), ('32', '4', '太阳宫'), ('29', '4', '安贞门'), ('64', '4', '宋家庄'), ('20', '4', '巴沟'), ('30', '4', '惠新西街南口'), ('48', '4', '慈寿寺'), ('63', '4', '成寿寺'), ('42', '4', '泥洼'), ('22', '4', '海淀黄庄'), ('60', '4', '潘家园'), ('19', '4', '火器营'), ('26', '4', '牡丹园'), ('24', '4', '知春路'), ('23', '4', '知春里'), ('34', '4', '石榴庄'), ('39', '4', '纪家庙'), ('31', '4', '芍药居'), ('21', '4', '苏州街'), ('38', '4', '草桥'), ('45', '4', '莲花桥'), ('25', '4', '西土城'), ('43', '4', '西局'), ('47', '4', '西钓鱼台'), ('36', '4', '角门东'), ('37', '4', '角门西'), ('17', '4', '车道沟'), ('56', '4', '金台夕照'), ('18', '4', '长春桥'), ('40', '4', '首经贸');
COMMIT;

-- ----------------------------
--  Table structure for `t_support_address`
-- ----------------------------
DROP TABLE IF EXISTS `t_support_address`;
