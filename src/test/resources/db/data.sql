INSERT INTO `t_user`(`id`, `name`, `email`, `phone_number`, `password`, `status`, `last_login_time`) VALUES (1, 'jhonrain',
'wali@imooc.com', '13888888888', 'wali', 1, NOW());
INSERT INTO `t_user`(`id`, `name`, `email`, `phone_number`, `password`, `status`, `last_login_time`) VALUES (2, 'admin',
'admin@imooc.com', '13999999999', '55b3d0936a3fb63168d57a6bda0ddbbf', 1, NOW());

INSERT INTO `t_role`(`id`, `user_id`, `name`) VALUES (1, 1, 'USER');
INSERT INTO `t_role`(`id`, `user_id`, `name`) VALUES (2, 2, 'USER');
INSERT INTO `t_role`(`id`, `user_id`, `name`) VALUES (3, 3, 'ADMIN');

-- address data
INSERT INTO `t_support_address`(`id`, `belong_to`, `en_name`, `cn_name`, `level`, `baidu_map_lng`, `baidu_map_lat`)
